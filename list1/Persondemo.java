class Person
{
    ...
    public Person(String nm,String gen,String cty,String mai,String bg,String no)
    {
        name=nm;
        gender=gen;
        city=cty;
    ...
    public void setter(String nm,String gen,String cty,String mai,String bg,String no)
    {
        name=nm;
        gender=gen;
        city=cty;
...
class Persondemo
{
    public static void main(String[] args)
    {
        ...
        p2.setter("parth", "male", "rajkot", "parth@gmail.com", "o+", "9876325140");
        p2.print();
